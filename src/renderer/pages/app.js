...
const Views = {
  ...
  'account' : createGetter(() => require('./account-page')),
  'purchase' : createGetter(() => require('./purchase-page')),
  'wallet' :  createGetter(() => require('./wallet-page')),
  'blockList':createGetter(() => require('./block-list')),
  'servers':createGetter(() => require('./servers-page')),
  'unconfirmedList':createGetter(() => require('./unconfirmed-list')),
  'service-page':createGetter(() => require('./publish-service-page'))
}
...
const Modals = {
  ...
  'vgo-dialog': createGetter(() => require('../components/vgo-dialog')),
  'show-resource-info' : createGetter(() => require('../components/show-resource-info-modal')),
  ...
  getModal () {
    ...
    return (
      <MuiThemeProvider muiTheme={lightMuiTheme}>
        <div key='modal' className='modal1'>
          <div key='modal-background' className='modal1-background' />
          <div key='modal-content' className='modal1-content'>
