...
class PreferencesPage extends React.Component {
  ...
  setDefaultAppButton () {
    ...
    if (isFileHandler) {
      return (
        <Preference>
          <p>VGO-Desktop is your default torrent app. Hooray!</p>
        </Preference>
      )
    }
    return (
      <Preference>
        <p>VGO-Desktop is not currently the default torrent app.</p>
        <RaisedButton
          className='control'
          onClick={this.handleSetDefaultApp}
          label='Make VGO-Desktop the default' />
      </Preference>
    )
  }
      ...
      <PreferencesSection title='Startup'>
        <Preference>
          <Checkbox
            ...
            label={'Open Gegewa-Desktop on startup.'}
